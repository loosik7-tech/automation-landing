...
const services = [
  ...
  },
  {
    ...
    desc: "Деликатный опрос клиента: имя, задача, номер телефона. Без навязчивости и лишних вопросов.",
  },
  {
    num: "III",
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 24 }}>
        {services.map((s) => (
          <div
            key={s.title}
            className="card"
            style={{ padding: 40, borderRadius: 24, boxShadow: "none", border: "1px solid var(--border)", transition: "border-color 0.3s" }}
